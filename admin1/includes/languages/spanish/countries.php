...
define('TABLE_HEADING_COUNTRY_STATUS', 'Estatus');
...
define('TEXT_INFO_COUNTRY_STATUS', 'Estatus (¿Habilitado para envios?):');
define('TEXT_INFO_INSERT_INTRO', 'Por favor, inserte el nuevo país con su información correspondiente');
...
define('ERROR_COUNTRY_IN_USE', 'ERROR: No se puede borrar el país seleccionado porque está asociado a un archivo de un cliente.');
define('ISO_COUNTRY_CODES_LINK', 'Referencias: <a href="http://www.iso.org/iso/country_codes/iso_3166_code_lists/country_names_and_code_elements.htm" target="_blank">ISO 3166 Alpha 2 Códigos de Países (ISO)</a> | <a href="http://en.wikipedia.org/wiki/ISO_3166-1_alpha-3" target="_blank">ISO 3166 Alpha 3 Códigos de Países (Wikipedia)</a>');
