...
define('HEADING_TITLE', '¡Precaución!');
define('ALERT_PART1', '¡Precaución: el acceso a la zona de administración está bloqueado por razones de seguridad.<br />Tiene que:');
