...
define('TEXT_MOVE_PRODUCTS_INTRO', 'Por favor, seleccione la categoría en la quiere que esté <b>%s</b>');
define('TEXT_MOVE_CATEGORIES_INTRO', 'Por favor, seleccione la categoría en la quiere que esté <b>%s</b>');
...
define('TEXT_PRODUCTO_AVAILABLE', 'En stock');
define('TEXT_PRODUCTO_NOT_AVAILABLE', 'Sin stock');
...
define('TEXT_PRODUCTS_QTY_BOX_STATUS_ON', 'Sí, mostrar cuadro de cantidad');
...
define('TEXT_PRODUCTS_DESCRIPTION', 'Descripción del Productos:');
...
// Products and Attribute Copy Options
 ...
 define('TEXT_PRODUCTS_QTY_BOX_STATUS_PREVIEW', 'Advertencia: No mostrar el cuadro de cantidad, cantidad por defecto 1');
  ...
  define('TEXT_PRODUCTS_QUANTITY_MAX_RETAIL_EDIT', '0 = Ilimitada, 1 = Sin cuadro de cantidad ni máximo');
