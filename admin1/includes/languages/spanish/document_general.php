...
define('TEXT_INFO_COPY_TO_INTRO', 'Por favor, elija una nueva categoría a la que desea copiar este producto');
...
define('TEXT_MOVE_PRODUCTS_INTRO', 'Por favor, seleccione la categoría en que quiere que esté <b>%s</b>');
define('TEXT_MOVE_CATEGORIES_INTRO', 'Por favor, seleccione la categoría en que quiere que esté <b>%s</b>');
define('TEXT_MOVE', 'Mover <b>%s</b> a:');

define('TEXT_NEW_CATEGORY_INTRO', 'Por favor, complete la siguiente información para la nueva categoría');
define('TEXT_CATEGORIES_NAME', 'Nombre de categoría:');
define('TEXT_CATEGORIES_IMAGE', 'Imagen de categoría:');
define('TEXT_SORT_ORDER', 'Orden:');

define('TEXT_DOCUMENT_STATUS', 'Estado del documento:');
define('TEXT_PRODUCTS_VIRTUAL', 'El Producto es virtual:');
define('TEXT_PRODUCTS_IS_ALWAYS_FREE_SHIPPING', 'Envío gratuito:');
define('TEXT_PRODUCTS_QTY_BOX_STATUS', 'Recuadro de cantidad del producto:');
define('TEXT_DOCUMENT_DATE_AVAILABLE', 'Fecha de disponibilidad:');
define('TEXT_DOCUMENT_AVAILABLE', 'Disponible');
define('TEXT_DOCUMENT_NOT_AVAILABLE', 'No disponible');
define('TEXT_PRODUCT_IS_VIRTUAL', 'Sí, no hace falta la dirección de envío');
define('TEXT_PRODUCT_NOT_VIRTUAL', 'No, hace falta la dirección de envío');
define('TEXT_PRODUCT_IS_ALWAYS_FREE_SHIPPING', 'Sí, envío gratuito');
define('TEXT_PRODUCT_NOT_ALWAYS_FREE_SHIPPING', 'No, reglas normales de envío');
define('TEXT_PRODUCT_SPECIAL_ALWAYS_FREE_SHIPPING', 'Especial, Producto/Descarga Combinación requieren la dirección de envío');
...
define('TEXT_DOCUMENT_NAME', 'Nombre del documento:');
define('TEXT_DOCUMENT_DETAILS', 'Contenido del documento:');
define('TEXT_DOCUMENT_IMAGE', 'Imagen del documento:');
define('TEXT_DOCUMENT_IMAGE_DIR', 'Subir a directorio:');
define('TEXT_DOCUMENT_URL', 'URL del documento:');
define('TEXT_DOCUMENT_URL_WITHOUT_HTTP', '<small>(sin http://)</small>');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_INFO_ATTRIBUTES_FEATURES_DELETE', 'Eliminar <strong>TODOS</strong> los aAtributos de producto para:<br />');
  ...
  define('TEXT_INFO_ATTRIBUTES_FEATURES_COPY_TO_CATEGORY', 'Copiar Attributos a otra <strong>categoría</strong> desde:<br />');
  ...
  define('TEXT_COPY_ATTRIBUTES_UPDATE', '<strong>Actualice</strong> con nuevas configuraciones/precios, y luego añada otros');
  ...
  define('TEXT_PRODUCTS_QTY_BOX_STATUS_PREVIEW', 'Advertencia: No mostrar el cuadro de cantidad, cantidad por defecto 1');
  define('TEXT_PRODUCTS_QTY_BOX_STATUS_EDIT', 'Advertencia: No mostrar el cuadro de cantidad, cantidad por defecto 1');
  ...
  define('TEXT_PRODUCTS_IS_FREE_PREVIEW', '*El producto esta marcado como GRATUITO');
  define('TEXT_PRODUCTS_IS_FREE_EDIT', '*El producto esta marcado como GRATUITO');

  define('TEXT_PRODUCT_IS_CALL', 'El producto es Pedir Precio:');
  define('TEXT_PRODUCTS_IS_CALL_PREVIEW', '*El producto esta marcado como PEDIR PRECIO');
  define('TEXT_PRODUCTS_IS_CALL_EDIT', '*El produco esta marcado como PEDIR PRECIO');

  define('TEXT_ATTRIBUTE_COPY_SKIPPING', '<strong>Saltando atributos nuevos</strong> ');
  define('TEXT_ATTRIBUTE_COPY_INSERTING', '<strong>Añadiendo atributos nuevos desde</strong> ');
