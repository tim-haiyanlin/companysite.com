...
// +----------------------------------------------------------------------+
//  $Id: product_notification.php 1105 2005-04-04 22:05:35Z Albigin $
//
...
define('JS_PLEASE_SELECT_PRODUCTS', 'Per favore seleziona qualche prodotto.');

define('BUTTON_GLOBAL', 'Globale');
define('BUTTON_SELECT', '>>>');
define('BUTTON_UNSELECT', '<<<');
define('BUTTON_SUBMIT', 'Invio');
define('BUTTON_CANCEL', 'Abbandona');
?>