...
define('HEADING_TITLE', 'Info Server');

define('TITLE_SERVER_HOST', 'Host Server:');
define('TITLE_SERVER_OS', 'OS Server:');
...
define('PROJECT_DATABASE_LABEL','Livello Patch Database: ');
