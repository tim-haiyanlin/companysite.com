 ...
 * @version $Id: linkpoint_review.php 4612 2006-10-28 17:05:05Z elvino $
 */

define('HEADING_TITLE', 'Riepilogo Carta di Credito');
...
define('TABLE_HEADING_LOGIN', 'Ultimo Login');
define('TABLE_HEADING_ACTION', 'Azione');
define('TABLE_HEADING_PRICING_GROUP', 'Gruppo Prezzi');
...
define('TEXT_INFO_NUMBER_OF_LOGONS', 'Numero di Accessi:');
define('TYPE_BELOW', 'Scrivi sotto');
define('PLEASE_SELECT', 'Seleziona Uno');
define('TEXT_INFO_NUMBER_OF_ORDERS', 'Numero di Ordini:');
