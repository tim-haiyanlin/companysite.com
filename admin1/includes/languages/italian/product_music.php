 ...
 * @version $Id: product_music.php 15883 2010-04-11 16:41:26Z Albigin $
*/
...
define('TEXT_PRODUCTS_RECORD_COMPANY', 'Etichetta:');
define('TEXT_PRODUCTS_MUSIC_GENRE', 'Genere Musicale:');
...
define('TEXT_DELETE_PRODUCT_INTRO', 'Davvero vuoi cancellare permanentemente questo prodotto?<br /><br />
<strong>Attenzione:</strong>Nei prodotti Linkati assicurarsi che la Categoria Master sia cambiata se state cancellando il prodotto da l&igrave;, spuntando il checkbox per il Prodotto nella Categoria Master stessa.');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_COPY_MEDIA_MANAGER','Copia tutte le collezioni connesse con questo prodotto.');
