<?php
// defines added for Mod: Multiple Categories Link Manager-Sorted v1.0
// +----------------------------------------------------------------------+
...
When you have checked all of the Categories that you want this Product to be linked to, press the "' . BUTTON_UPDATE_CATEGORY_LINKS . '" button.<br />'
);
...
// Mod: Multiple Categories Link Manager-Sorted v1.0 - BEGIN CEON MODIFICATIONS 1.0.0 1 of 1
define('MOD_SORTED_TEXT_LABEL_BASE_TARGET_CATEGORY', 'Base Target Category');
define('MOD_SORTED_BUTTON_SELECT', 'Select');
define('MOD_SORTED_TEXT_TARGET_CATEGORIES', 'Target Categories');
define('MOD_SORTED_TEXT_TARGET_SELECT_CATEGORY_ALL_CATEGORIES', 'All Categories');
define('MOD_SORTED_TEXT_SELECT_ALL_OR_NONE', 'Select All or None');
// END CEON MODIFICATIONS 1.0.0 1 of 1
// BEGIN CEON MODIFICATIONS 1.2.0 2 of 2
define('MOD_SORTED_HEADER_COPY_TO_PRODUCT', 'Copy Linked Categories to Another Product');
define('MOD_SORTED_TEXT_INFO_COPY_LINKED_CATEGORIES_TO_ANOTHER_PRODUCT', 'Copy the linked categories (but not the master category) of the <strong>currently selected product</strong> to another product.');
define('MOD_SORTED_TEXT_SELECT_THE_TARGET_PRODUCT', 'Select the target product');
define('MOD_SORTED_BUTTON_COPY_TO_ANOTHER_PRODUCT', 'Copy to selected target product');
define('MOD_SORTED_ERROR_NO_TARGET_PRODUCT_SELECTED', 'A target product was not selected!');
define('MOD_SORTED_SUCCESS_LINKED_CATEGORIES_COPIED_TO_TARGET_PRODUCT', 'The list of linked categories has been copied to the target product: \'%s\'');
// END CEON MODIFICATIONS 1.2.0 2 of 2
?>