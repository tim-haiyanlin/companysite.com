 ...
 */
define('HEADING_TITLE', 'Kredit Korts Visning');
...
define('TABLE_HEADING_AUTHORIZATION_APPROVAL', 'Godk&auml;nd');
...
define('TEXT_INFO_NUMBER_OF_ORDERS', 'Antal ordrar:');
define('TEXT_INFO_LAST_ORDER','Senaste order:');
define('TEXT_INFO_ORDERS_TOTAL', 'Total:');

define('ENTRY_NONE', 'Inget');
