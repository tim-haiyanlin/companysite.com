...
define('TEXT_WARNING_SSL_EDIT', 'ALARM: <a href="http://www.zen-cart-pro.at" target="_blank">Aus Sicherheitsgründen sind Änderungen deaktiviert, solange für Ihren Adminbereich keine SSL Verschlüsselung aktiviert wurde</a>.');
define('TEXT_WARNING_SSL_INSTALL', 'ALARM: <a href="http://www.zen-cart-pro.at" target="_blank">Aus Sicherheitsgründen ist die Installation dieses Modules deaktiviert, solange für Ihren Adminbereich keine SSL Verschlüsselung aktiviert wurde</a>.');