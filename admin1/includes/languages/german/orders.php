<?php
/**
 * @package admin (German) modified for Edit Orders v4.x
 * @copyright Copyright 2003-2014 Zen Cart Development Team
 * @copyright Portions Copyright 2003 osCommerce
 * @license http://www.zen-cart.com/license/2_0.txt GNU Public License V2.0
 * @translators: cyaneo/hugo13/wflohr/maleborg/webchills	http://www.zen-cart.at
 * @translators: frank18	http://isonetwork.net.au
 * @version $Id: orders.php 6218 2014-10-11 22:50:14Z frank18 $
 */
...
define('BUTTON_TO_LIST', 'Bestellungsliste');
define('SELECT_ORDER_LIST', 'Bestellung wählen:');
// END EDIT ORDERS  ----------------------------------------------