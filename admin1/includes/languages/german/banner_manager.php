...
define('ERROR_GRAPHS_DIRECTORY_NOT_WRITEABLE', 'Achtung! Das Grafikverzeichnis ist nicht beschreibbar. Es befindet sich hier: <strong>' . DIR_WS_ADMIN . 'images/graphs</strong>');
