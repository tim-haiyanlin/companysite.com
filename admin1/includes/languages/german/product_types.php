...
// +----------------------------------------------------------------------+
//  $Id: product_types.php 302 2008-05-30 19:49:12Z maleborg $
//
...
define('TEXT_HEADING_DELETE_PRODUCT_TYPE', 'Artikeltyp löschen');

define('TEXT_PRODUCT_TYPES', 'Artikeltypen:');
define('TEXT_PRODUCT_TYPES_HANDLER', 'Zufuhrseite:');
define('TEXT_PRODUCT_TYPES_ALLOW_ADD_CART', 'Dieser Artikel kann zum Warenkorb hinzugefügt werden:');
