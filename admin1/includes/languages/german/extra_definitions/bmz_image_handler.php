 ...
 * @version $Id: bmz_image_handler.php 2014-02-22 09:46:5 webchills $
 */

define('BOX_TOOLS_IMAGE_HANDLER', 'Image Handler 4.4');
define('ICON_IMAGE_HANDLER','Image Handler 4.4');
...
define('IH_HEADING_TITLE', 'Image Handler 4.4');
...
define('IH_ABOUT_DOKU','<h2>Image Handler 4.4 für Zen-Cart 1.5.2 deutsch</h2>

<p>
Image Handler 4.4 für Zen-Cart 1.5.2 deutsch basiert auf der Grundentwicklung von Tim Kröger.<br /></p>
<fieldset>
