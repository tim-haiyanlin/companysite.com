...
define('HEADING_TITLE', 'Examen de carte de crédit');

define('TABLE_HEADING_ID', 'ID#');
define('TABLE_HEADING_FIRSTNAME', 'Prénom');
define('TABLE_HEADING_LASTNAME', 'Nom');
define('TABLE_HEADING_ACCOUNT_CREATED', 'Compte créé le');
...
define('TEXT_DATE_ACCOUNT_LAST_MODIFIED', 'Dernièrement modifié :');
...
define('TEXT_INFO_NUMBER_OF_ORDERS', 'Nombres de commandes :');
