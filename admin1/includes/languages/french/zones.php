...
define('TEXT_INFO_INSERT_INTRO', 'Veuillez saisir la nouvelle zone et ses données connexes');
define('TEXT_INFO_DELETE_INTRO', 'Êtes-vous sûr de vouloir supprimer cette zone ?');
define('TEXT_INFO_HEADING_NEW_ZONE', 'Nouvelle zone');
define('TEXT_INFO_HEADING_EDIT_ZONE', 'Éditer la zone');
