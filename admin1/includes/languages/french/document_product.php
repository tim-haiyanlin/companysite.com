...
define('TEXT_DELETE_PRODUCT_INTRO', 'Êtes-vous sûr(e) de vouloir supprimer ce produit de façon permanente ?<br /><br /><strong>Attention :</strong> Sur les produits liés<br />1 Assurez-vous que la catégorie maître a été changée si vous supprimez le produit à partir de la catégorie maître<br />2 Cochez la case de la catégorie du produit à supprimer');
...
define('TEXT_PRODUCTS_IMAGE_DIR', 'Téléchargement vers le répertoire :');
