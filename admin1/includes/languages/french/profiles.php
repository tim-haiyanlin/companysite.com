...
define('HEADING_TITLE_INDIVIDUAL_PROFILE', 'Profil pour %s ');
...
define('ERROR_INVALID_PROFILE_NAME', 'Veuillez saisir un nom valide pour le profil');
...
define('SUCCESS_PROFILE_UPDATED', 'Profil mis à jour.');
define('SUCCESS_PROFILE_NAME_UPDATED', 'Nom du profil mis à jour');
