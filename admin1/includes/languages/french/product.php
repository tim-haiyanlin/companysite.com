...
define('TEXT_DELETE_CATEGORY_INTRO', 'Êtes-vous certain(e) de vouloir supprimer cette catégorie ?');
define('TEXT_DELETE_PRODUCT_INTRO', 'Êtes-vous certain(e) de vouloir supprimer ce produit de façon permanente ?<br /><br /><strong>Attention :</strong> Sur les produits liés<br />1 Assurez-vous que la catégorie maître a été changée si vous supprimez le produit depuis la catégorie maître<br />2 Cochez la case de la catégorie du produit à supprimer');
...
define('TEXT_PRODUCTS_QUANTITY', 'Quantité du Produit :');
...
define('TEXT_PRODUCTS_PRICE_NET', 'Prix (HT) du Produit :');
define('TEXT_PRODUCTS_PRICE_GROSS', 'Prix (TTC) du Produit:');
define('TEXT_PRODUCTS_WEIGHT', 'Poids d\'expédition du Produit :');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_COPY_ATTRIBUTES','Copier les attributs du produit au dupliqué ?');
  define('TEXT_COPY_ATTRIBUTES_YES','Oui');
  define('TEXT_COPY_ATTRIBUTES_NO','Non');

// Products and Discount Copy Options
  define('TEXT_COPY_DISCOUNTS_ONLY','Utilisé seulement pour les produits dupliqués avec remises ...');
  define('TEXT_COPY_DISCOUNTS','Copier les remises du produit au dupliqué ?');
