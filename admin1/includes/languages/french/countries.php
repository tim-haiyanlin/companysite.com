...
define('TEXT_INFO_COUNTRY_STATUS', 'Statut (Actif pour l\'expédition ?) :');
define('TEXT_INFO_INSERT_INTRO', 'Veuillez saisir le nouveau pays et ses données relatives');
define('TEXT_INFO_DELETE_INTRO', 'Êtes-vous sûr(e) de vouloir supprimer ce pays ?');
...
define('ERROR_COUNTRY_IN_USE', 'ERREUR: Impossible de supprimer le pays sélectionné car il est utilisé par des données de clients.');
define('ISO_COUNTRY_CODES_LINK', '<a href="http://www.iso.org/iso/country_codes/iso_3166_code_lists.htm" target="_blank">Référence de Codes pour Pays ISO 3166</a>');