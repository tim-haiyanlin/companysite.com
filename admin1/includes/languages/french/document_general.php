...
define('TEXT_INFO_CURRENT_CATEGORIES', 'Catégories actuelle : ');
...
define('TEXT_DOCUMENT_IMAGE_DIR', 'Télécharger vers le répertoire :');
...
// Products and Attribute Copy Options
  ...
  define('TEXT_INFO_CURRENT_PRODUCT', 'Produit actuels : ');
...
// meta tags
  ...
  define('TEXT_PRODUCTS_METATAGS_TITLE_TAGLINE_STATUS','<strong>Titre/Slogan :</strong>');
  define('TEXT_META_TAGS_TITLE','<strong>Balise Meta du Titre :</strong>');
  define('TEXT_META_TAGS_KEYWORDS','<strong>Balise Meta Tag des Mots-clés :</strong>');
