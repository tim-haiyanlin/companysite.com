...
define('HEADING_TITLE', 'Verstuur e-mail aan klanten');
...
define('TEXT_ATTACHMENTS_DIR','Directorie voor opslaan: ');

define('NOTICE_EMAIL_SENT_TO', 'Opmerking: e-mail verstuurd aan: %s');
define('NOTICE_EMAIL_FAILED_SEND', 'Notitie: FOUT verzenden Email naar alle ontvangers: %s');
