...
define('TEXT_INFO_INSERT_INTRO', 'Voer de nieuwe taal in met alle relevante gegevens');
define('TEXT_INFO_DELETE_INTRO', 'Weet je zeker dat je deze taal wilt verwijderen?');
