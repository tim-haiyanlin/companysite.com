...
define('TEXT_PRODUCTS_RECORD_ARTIST', 'Artiest:');
define('TEXT_PRODUCTS_RECORD_COMPANY', 'Platenmaatschappij:');
define('TEXT_PRODUCTS_MUSIC_GENRE', 'Genre:');
...
// Products and Opties Copy Options
  ...
  define('TEXT_COPY_MEDIA_MANAGER','Kopieer Media Manager collecties gekoppeld aan dit artikel.');
