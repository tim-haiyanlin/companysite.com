...
define('TEXT_DELETE_PRODUCT_INTRO', 'Weet je zeker dat je dit artikel wilt verwijderen?<br /><br /><strong>Waarschuwing:</strong> bij gekoppelde artikelen:<br />1 Zorg dat de hoofdcategorie is veranderd als je dit artikel daar vandaan wordt verwijderd<br />2 Markeer onderstaande "checkbox" van de categorie om het artikel uit deze categorie te verwijderen.');

define('TEXT_DELETE_WARNING_CHILDS', '<b>Waarschuwing: </b>er zijn nog steeds %s (sub)categorieën gekoppeld aan deze categorie!');
...
define('TEXT_NEW_CATEGORY_INTRO', 'Voer de nieuwe categorie in met alle relevante gegevens');
...
define('TEXT_DOCUMENT_STATUS', 'Status voorraad:');
...
define('TEXT_DOCUMENT_DATE_AVAILABLE', 'Startdatum:');
define('TEXT_DOCUMENT_AVAILABLE', 'Op voorraad');
define('TEXT_DOCUMENT_NOT_AVAILABLE', 'Niet op voorraad');
...
define('TEXT_DOCUMENT_NAME', 'Naam document:');
define('TEXT_DOCUMENT_DETAILS', 'Inhoud document:');
define('TEXT_DOCUMENT_IMAGE', 'Afbeelding document:');
define('TEXT_DOCUMENT_IMAGE_DIR', 'Opslaan in directory:');
define('TEXT_DOCUMENT_URL', 'URL document:');
define('TEXT_DOCUMENT_URL_WITHOUT_HTTP', '<small>(zonder http://)</small>');
...
// Products and Opties Copy Options
  ...
  define('TEXT_CATEGORIES_IMAGE_DIR','Opslaan in directory:');
...
// meta tags
  define('TEXT_META_TAG_TITLE_INCLUDES','<strong>Vink aan wat in titel van het document als meta tag zichtbaar moet zijn:</strong>');
  define('TEXT_PRODUCTS_METATAGS_PRODUCTS_NAME_STATUS','<strong>Documentnaam</strong>');
