...
define('TEXT_COUNT_CUSTOMERS', 'Klanten die nieuwsbrieven ontvangen: %s');
define('HEADING_TITLE', 'Nieuwsbriefmanager');
...
define('TEXT_PLEASE_SELECT_AUDIENCE','Selecteer de doelgroep voor deze nieuwsbrief: ');
define('TEXT_PLEASE_WAIT', 'Even geduld .. e-mails aan het versturen ..<br /><br />Zorg er voor dat dit proces niet wordt onderbroken!');
define('TEXT_FINISHED_SENDING_EMAILS', 'Klaar met e-mails verzenden!');
