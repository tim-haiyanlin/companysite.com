...
define('HEADING_TITLE', 'Artikelsoort');
define('HEADING_TITLE_LAYOUT', 'Lay-out opties artikelsoort: ');

define('TABLE_HEADING_PRODUCT_TYPES', 'Artikelsoort');
define('TABLE_HEADING_PRODUCT_TYPES_ALLOW_ADD_TO_CART', 'Toevoegen<br />aan winkelwagen');
...
define('TEXT_HEADING_NEW_PRODUCT_TYPE', 'Nieuw artikelsoort');
define('TEXT_HEADING_EDIT_PRODUCT_TYPE', 'Wijzig artikelsoort');
define('TEXT_HEADING_DELETE_PRODUCT_TYPE', 'Verwijder artikelsoort');

define('TEXT_PRODUCT_TYPES', 'Artikelsoort:');
define('TEXT_PRODUCT_TYPES_HANDLER', 'Opgeslagen in admin/includes/languages/dutch/:');
define('TEXT_PRODUCT_TYPES_ALLOW_ADD_CART', 'Dit artikelsoort kan aan de winkelwagen worden toegevoegd:');
