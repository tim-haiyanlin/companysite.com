        ...
        <div id="categories-content-wrapper" class="section featured-categories">
            <div class="container">
                <div class="brands-slider">
	                ...
	                $mybutton="<span id='mycompanybutton'>".strtoupper(HEADER_TITLE_MAIN_FEATURED_CATEGORIES)."</span>";
	                 
						  ?>
						   
                            <h4 class="section-title" style="margin-top:20px"><?php echo  $mybutton;?></h4>
                            <div class="row">
