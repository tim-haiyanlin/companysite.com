...
<!-- BOF COMPANY Mainmenu 2015 07 20 -->
<script src="<?php  echo $template->get_template_dir('',DIR_WS_TEMPLATE, $current_page_base,'jscript').'/companymenumaker.js'?>" type="text/javascript"></script>
<!-- EOF  COMPANY Mainmenu -->
