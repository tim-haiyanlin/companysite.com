...
?>
	<!-- menu area -->
        ...
        <?php 
          //$menulist = str_replace('<ul class="level1">','',$menulist);
          //$menulist = str_replace('</ul>','',$menulist);
          //echo $menulist; 
        ?>
            ...
            ?>
            <li class="<?php if($pg=='products.html') { echo "tab_active";}?>">
            	<a href="<?php echo zen_href_link(FILENAME_PRODUCTS_NEW."&pg=products"); ?>">		
                    <?php echo CATEGORIES_BOX_HEADING_WHATS_NEW; ?>
                </a>
            </li>
            <li class="<?php if($pg=='featured_products.html') { echo "tab_active";}?>">
            	<a href="<?php echo zen_href_link(FILENAME_FEATURED_PRODUCTS."&pg=featured_products"); ?>">		
                    <?php echo CATEGORIES_BOX_HEADING_FEATURED_PRODUCTS; ?>
                </a>
            </li>
            <li class="<?php if($pg=='all_products.html') { echo "tab_active";}?>">
            	<a href="<?php echo zen_href_link(FILENAME_PRODUCTS_ALL."&pg=all_products"); ?>">		
                    <?php echo CATEGORIES_BOX_HEADING_PRODUCTS_ALL; ?>
                </a>
            </li>
            <li id='brands' class="<?php if($pg=='brands.html') { echo "tab_active";}?>" >
            	<a href="#<?php //echo zen_href_link("index&manufacturers_id=".$manufacturers_id."&pg=brands"); ?>">
					<?php echo HEADER_TITLE_MANUFACTURER; ?>
                </a>
                	<ul class="">
                    	<?php
