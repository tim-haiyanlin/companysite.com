 ...
 */
$content = '<div class="widget widget-contact"><h4 class="widget-title">TESTIMONIALS</h4>';
  $content .= '<div id="' . str_replace('_', '-', $box_id . 'Content') . '" class="sideBoxContent mysideBoxContent">';
