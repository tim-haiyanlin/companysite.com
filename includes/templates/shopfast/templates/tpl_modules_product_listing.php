 ...
 */
 // echo (DIR_WS_MODULES . zen_get_module_directory(FILENAME_PRODUCT_LISTING));
...
require($template->get_template_dir('tpl_shopfast_productlisting.php',DIR_WS_TEMPLATE, $current_page_base,'common'). '/tpl_shopfast_productlisting.php');
