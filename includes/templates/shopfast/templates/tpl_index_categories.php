...
<div class="centerColumn" id="indexCategories">
    ...
    ?>
    <div id="categoryImgListing" class="categoryImg col-md-12 col-sm-12"><?php echo zen_image(DIR_WS_IMAGES . $categories_image, '', SUBCATEGORY_IMAGE_TOP_WIDTH, SUBCATEGORY_IMAGE_TOP_HEIGHT); ?></div>
    <?php
      }
    } // categories_image
    ?>
...
<?php 
 ...
 // echo "here tim make change and product father id is ".$cPath;
 // echo "<br>locate is  includes templates shopfast templates tpl_index_categories.php <br>";

 require($template->get_template_dir('/tpl_modules_products_companys_listing.php',DIR_WS_TEMPLATE, $current_page_base,'templates'). '/tpl_modules_products_companys_listing.php'); 
