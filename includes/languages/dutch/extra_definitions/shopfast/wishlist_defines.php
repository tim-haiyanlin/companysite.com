...
define('UN_BUTTON_WISHLIST_ADD_ALT', 'Voeg toe aan wenslijst');
define('UN_BOX_WISHLIST_ADD_TEXT', 'Klik om dit product toe te voegen aan uw wensenlijst.');
define('UN_BOX_WISHLIST_LOGIN_TEXT', '<p><a href="' . zen_href_link(FILENAME_LOGIN, '', 'NONSSL') . '">Log In</a> in staat zijn om dit product toe te voegen aan uw wensenlijst.</p>');

// control form
define('UN_TEXT_SORT', 'sorteren');
define('UN_TEXT_SHOW', 'tonen');
define('UN_TEXT_VIEW', 'uitzicht');
define('UN_TEXT_ALL_CATEGORIES', 'alle Categorieën');

// more
define('UN_TEXT_ADD_WISHLIST', 'Zet op verlanglijst');
define('UN_TEXT_REMOVE_WISHLIST', 'Verwijderen uit verlanglijst');
define('UN_BUTTON_IMAGE_SAVE', BUTTON_IMAGE_UPDATE);
define('UN_BUTTON_SAVE_ALT', BUTTON_UPDATE_ALT);
define('UN_TEXT_EMAIL_WISHLIST', 'Vertel een vriend');
define('UN_TEXT_FIND_WISHLIST', 'Vind een vriend\'s Wish List');
define('UN_TEXT_NEW_WISHLIST', 'Maak een nieuwe Wish List');
define('UN_TEXT_MANAGE_WISHLISTS', 'Beheer mijn Wish Lists');
define('UN_TEXT_WISHLIST_MOVE', 'Verplaats items tussen Wish Lists');
define('SUCCESS_ADDED_TO_WISHLIST_PRODUCT', '<button class="close" aria-hidden="true" data-dismiss="alert" type="button">×</button>Succesvol product is toegevoegd aan Wish List');
