...
define('SUCCESS_NOTIFICATIONS_UPDATED', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Uw productnotificatie instellingen zijn opgeslagen.');
?>