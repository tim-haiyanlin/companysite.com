...
define('TEXT_PRODUCT_NOT_FOUND', 'Helaas kon het artikel niet worden gevonden.');
...
define('TEXT_ONETIME_CHARGE_DESCRIPTION', ' eenmalig toeslag kan van toepassing zijn');
