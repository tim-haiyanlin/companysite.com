...
define('TEXT_ALSO_PURCHASED_PRODUCTS', 'También Comprado');
...
define('TEXT_PRODUCT_QUICK_OVERVIEW', 'Descripción Rápida');
define('TEXT_PRODUCT_QUICK_DESCRIPTION', 'Descripción');
define('TEXT_PRODUCT_QUICK_REVIEWS', 'Opiniones');
define('TEXT_PRODUCT_NO_REVIEWS', 'No hay opiniones para este producto.');
