...
define('TEXT_404_ERROR', 'error'); 
define('TEXT_404_PAGE', 'página'); 
define('TEXT_404_ERROR_TEXT', 'La página no se puede encontrar...'); 
define('HEADER_TITLE_404_CATALOG', 'Ir Inicio');
?>