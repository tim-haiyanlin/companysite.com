...
define('BUTTON_CONFIRM_SEND_ALT', 'Enviar Vale de Compra');
...
define('BUTTON_LOGIN_ALT', 'Entrar/Registrarse');
define('BUTTON_PREVIOUS_ALT', '<i class="fa fa-angle-left" data-toggle="tooltip" data-original-title="Producto anterior""></i>');
define('BUTTON_NEXT_ALT', '<i class="fa fa-angle-right" data-toggle="tooltip" data-original-title="Siguiente producto""></i>');
...
define('BUTTON_SEND_ANOTHER_ALT', 'Enviar otro Vale de Compra');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Enviar un Vale de Compra');
