...
define('TEXT_RECORD_COMPANY_URL', 'Para más información, visite la <a href="%s" target="_blank">web oficial</a> de la compañía discográfica.');
define('TEXT_ARTIST_URL', 'Para más información, visite la <a href="%s" target="_blank">web oficial</a> del artista.');
...
define('TEXT_PRODUCT_RECORD_COMPANY', 'Compañía Discográfica: ');
