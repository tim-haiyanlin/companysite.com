...
define('HEADER_TITLE_CHECKOUT', 'Encaisser');
...
define('HEADER_ALT_TEXT', 'Propulsé par Zen Cart :: L\'Art du E-Commerce [lien accueil]');
define('HEADER_SALES_TEXT', '<h1>Les messages commerciaux vont ici</h1>');
...
define('HEADER_SEARCH_DEFAULT_TEXT','Entrer les mots-clés de recherche ici');
?>