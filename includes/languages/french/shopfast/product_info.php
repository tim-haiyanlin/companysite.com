...
define('TEXT_MORE_INFORMATION', 'Pour plus d\'informations, veuillez consulter la <a href="%s" target="_blank">page web</a> de ce produit.');
...
define('TEXT_ALSO_PURCHASED_PRODUCTS', 'Ont Aussi Acheté');
...
define('TEXT_PRODUCT_QUICK_OVERVIEW', 'Description Rapide');
define('TEXT_PRODUCT_QUICK_DESCRIPTION', 'Description');
define('TEXT_PRODUCT_QUICK_REVIEWS', 'Avis');
define('TEXT_PRODUCT_NO_REVIEWS', 'Il ny a aucun commentaire sur ce produit.');
