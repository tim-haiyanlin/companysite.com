...
//
  ...
  define('SUCCESS_ACCOUNT_UPDATED', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Votre compte a été mis à jour avec succès.');
?>