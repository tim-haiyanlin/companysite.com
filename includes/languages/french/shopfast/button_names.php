...
define('BUTTON_CREATE_ACCOUNT_ALT', 'S\'inscrire');
define('BUTTON_LOG_OFF_ALT', 'Se déconnecter');
define('BUTTON_ADD_TO_CART_ALT', 'Ajouter à mon panier');
define('BUTTON_ADD_ADDRESS_ALT', 'Ajouter une adresse');
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','Ajouter les produits choisis au panier');
define('BUTTON_BACK_ALT', 'Retour');
define('BUTTON_BUY_NOW_ALT', 'Acheter maintenant');
define('BUTTON_CANCEL_ALT', 'Annuler');  
define('BUTTON_CHANGE_ADDRESS_ALT', 'Modifier l\'adresse');
define('BUTTON_CHECKOUT_ALT', 'Encaisser');
define('BUTTON_CONFIRM_SEND_ALT', 'Envoyer le chèque cadeau');
define('BUTTON_CONFIRM_ORDER_ALT', 'Confirmer la commande');
...
define('BUTTON_DOWNLOAD_ALT', 'Télécharger maintenant');
define('BUTTON_EDIT_SMALL_ALT', 'Éditer');
define('BUTTON_IN_CART_ALT', 'Ajouter au panier');
define('BUTTON_LOGIN_ALT', 'Connection');
define('BUTTON_PREVIOUS_ALT', '<i class="fa fa-angle-left" data-toggle="tooltip" data-original-title="Produit Précédent""></i>');
define('BUTTON_NEXT_ALT', '<i class="fa fa-angle-right" data-toggle="tooltip" data-original-title="Produit Suivant""></i>');
define('BUTTON_REDEEM_ALT', 'Rembourser/Réclamer');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Retour à la liste des produits');
define('BUTTON_REVIEWS_ALT', 'Aller à la page des avis');
define('BUTTON_SEARCH_ALT', 'Rechercher');
define('BUTTON_SEND_ALT', 'Envoyer');
define('BUTTON_SEND_ANOTHER_ALT', 'Envoyer un autre chèque cadeau');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Envoyer un chèque cadeau');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', 'Estimateur des frais de livraison');
define('BUTTON_SOLD_OUT_ALT', 'Épuisé');
define('BUTTON_SOLD_OUT_SMALL_ALT', 'Épuisé');
define('BUTTON_SUBMIT_ALT', 'Soumettre les informations');
define('BUTTON_UNSUBSCRIBE', 'Se désabonner');
define('BUTTON_UPDATE_ALT', 'Actualiser');
define('BUTTON_VIEW_SMALL_ALT', 'Visualiser');
define('BUTTON_WRITE_REVIEW_ALT', 'Écrire un avis');
define('BUTTON_READ_REVIEWS_ALT', 'Lire l\'avis');
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'Aller à l\'information détaillée de ce produit');
define('BUTTON_MORE_REVIEWS_ALT', 'Lire plus d\'avis');