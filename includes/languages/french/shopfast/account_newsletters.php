...
define('SUCCESS_NEWSLETTER_UPDATED', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Vos abonnements aux bulletins a été actualisé avec succès.');
?>