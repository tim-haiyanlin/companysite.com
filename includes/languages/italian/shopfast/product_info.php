...
define('TEXT_ALSO_PURCHASED_PRODUCTS', 'Anche Acquistati');
...
define('TEXT_PRODUCT_QUICK_OVERVIEW', 'Introduzione Veloce');
define('TEXT_PRODUCT_QUICK_DESCRIPTION', 'Descrizione');
define('TEXT_PRODUCT_QUICK_REVIEWS', 'Recensioni');
define('TEXT_PRODUCT_NO_REVIEWS', 'Non ci sono commenti per questo prodotto.');
