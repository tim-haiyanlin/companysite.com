...
define('TEXT_NO_PAYMENT_OPTIONS_AVAILABLE','<span class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Spiacenti, ma attualmente non accettiamo pagamenti da questa localit&agrave;.</span><br />Se interessato puoi contattarci per eventuali opzioni alternative.');
