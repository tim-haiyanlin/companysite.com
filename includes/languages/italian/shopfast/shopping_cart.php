...
define('SUB_TITLE_SUB_TOTAL', 'Totale parziale:');
define('SUB_TITLE_TOTAL', 'Totale:');
define('TABLE_HEADING_UPDATE', 'Aggiornare');
define('TABLE_HEADING_DELETE', 'Cancellare');

define('OUT_OF_STOCK_CANT_CHECKOUT', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>I prodotti segnalati con ' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . ' sono esauriti oppure presenti in quantitativi insufficienti a soddisfare la tua richiesta.<br />Rivedi per favore il quantitativo dei prodotti contrassegnati come (' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . '). Grazie');
define('OUT_OF_STOCK_CAN_CHECKOUT', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>I prodotti segnalati con ' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . ' sono esauriti.<br />I prodotti esauriti saranno riordinati.');
