...
if ( ($category_depth == 'products') || (zen_check_url_get_terms()) ) {
  ...
  define('TEXT_NO_PRODUCTS', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Al momento non vi sono prodotti in questo reparto.');
  define('TEXT_NO_PRODUCTS2', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Al momento non abbiamo articoli di questo produttore.');
