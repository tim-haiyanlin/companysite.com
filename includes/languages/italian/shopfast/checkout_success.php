...
define('TEXT_SEE_ORDERS', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Puoi visualizzare lo storico dei tuoi ordini andando alla pagina <a href="' . zen_href_link(FILENAME_ACCOUNT, '', 'SSL') . '" name="linkMyAccount">Il tuo account</a> e cliccando su Visualizza tutti gli ordini.');
...
define('TEXT_THANKS_FOR_SHOPPING', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Grazie per aver fatto acquisti Online con noi!');
...
define('TEXT_CHECKOUT_LOGOFF_GUEST', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>NOTA: Per completare il tuo ordine &egrave stato creato un account temporaneo. Puoi chiudere questo account cliccando in Esci. Cliccando nel link Esci sei sicuro che le informazioni sui tuoi acquisti non siano visibili alle altre persone che possono accedere a questo computer. Se desideri continuare gli acquisti, fallo liberamente! Puoi uscire in qualsiasi momento il link Esci.');
define('TEXT_CHECKOUT_LOGOFF_CUSTOMER', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Grazie del tuo acquisto. Clicca nel link Esci per essere sicuro che le informazioni sui tuoi acquisti non siano visibili alle altre persone che possono accedere a questo computer.');
