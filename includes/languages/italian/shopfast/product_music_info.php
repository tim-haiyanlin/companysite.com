 ...
 * @version $Id: product_music_info.php 6371 2007-05-25 19:55:59Z sandrocarniel $
 */

define('TEXT_PRODUCT_NOT_FOUND', 'Spiacenti, non abbiamo trovato il prodotto.');
define('TEXT_CURRENT_REVIEWS', 'Recensioni attuali:');
define('TEXT_RECORD_COMPANY_URL', 'Per maggiori informazioni, visita il sito della <a href="%s" target="_blank">Casa Discografica</a>.');
define('TEXT_ARTIST_URL', 'Per maggiori informazioni, visita il sito dell\'<a href="%s" target="_blank">Artista </a>.');
define('TEXT_DATE_ADDED', 'A catalogo dal %s.');
define('TEXT_DATE_AVAILABLE', '<font color="#ff0000">Articolo disponibile il %s.</font>');
...
define('TEXT_PRODUCT_RECORD_COMPANY', 'Casa Discografica: ');
...
define('TEXT_PRODUCT_COLLECTIONS', 'Supporto: ');
