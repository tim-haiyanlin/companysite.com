...
define('HEADING_TITLE', 'Fase 1 di 3 - Info per la spedizione');

define('TABLE_HEADING_SHIPPING_ADDRESS', 'Indirizzo spedizione');
define('TEXT_CHOOSE_SHIPPING_DESTINATION', 'La spedizione verr&agrave; fatta all\'indirizzo riportato a sinistra. Se necessario puoi modificarlo cliccando sul bottone <em>Cambia indirizzo</em> qui accanto.');
