...
define('BUTTON_PREVIOUS_ALT', '<i class="fa fa-angle-left" data-toggle="tooltip" data-original-title="Prodotto Precedente""></i>');
define('BUTTON_NEXT_ALT', '<i class="fa fa-angle-right" data-toggle="tooltip" data-original-title="Prodotto Successivo""></i>');
