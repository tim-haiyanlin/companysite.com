 ...
 */
  ...
  define('MODULE_ORDER_TOTAL_COUPON_HEADER', TEXT_GV_NAMES . '/Buoni sconto');
  define('MODULE_ORDER_TOTAL_COUPON_DESCRIPTION', 'Buoni sconto');
  define('MODULE_ORDER_TOTAL_COUPON_TEXT_ENTER_CODE', TEXT_GV_REDEEM);
  define('MODULE_ORDER_TOTAL_COUPON_HEADER', TEXT_GV_NAMES . '/Buoni sconto');
  define('SHIPPING_NOT_INCLUDED', ' [Costi spedizione esclusi]');
  define('TAX_NOT_INCLUDED', ' [IVA esclusa]');
  define('IMAGE_REDEEM_VOUCHER', 'Buono Sconto');
  define('MODULE_ORDER_TOTAL_COUPON_REDEEM_INSTRUCTIONS', '<p>Digita il codice del tuo Buono nel campo a fianco della scritta Riscuoti Buono. Il Buono sar&agrave; utilizzato per intero ed il suo importo verr&agrave; defalcato dal conto una volta premuto il bottone continua.</p><p>Nota: si pu&ograve; utilizzare un solo buono per ordine.</p>');
