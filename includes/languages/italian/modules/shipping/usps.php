...
define('MODULE_SHIPPING_USPS_TEXT_DESCRIPTION', 'United States Postal Service<br /><br />Per utilizzare questo modulo sar&agrave; necessario registrare un account presso il sito <a href="http://www.usps.com/webtools/" target="_blank">USPS</a>.<br /><br /><strong>ATTENZIONE</strong> con USPS &egrave; necessario utilizzare il <strong>pound</strong> quale unit&agrave; di misura NON il Kg. per gli articoli.' . ((MODULE_SHIPPING_USPS_USERID == 'NONE' || MODULE_SHIPPING_USPS_USERID == '' || MODULE_SHIPPING_USPS_SERVER == 'test') ? '<br /><br /><strong>Creating a customer account for USPS realtime shipping quotes</strong><br />
