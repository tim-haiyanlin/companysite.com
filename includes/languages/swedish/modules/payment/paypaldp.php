 ...
 * @version $Id: paypaldp.php 19115 2011-07-15 07:05:01Z drbyte $
 */
/*
 ...
 *
 * Denna &auml;r inte den som &auml;r b&auml;st f&ouml;r svenska butiker. Vi har d&auml;rf&ouml;r inte valt att &ouml;vers&auml;tta den.
 */
  define('MODULE_PAYMENT_PAYPALDP_TEXT_ADMIN_TITLE_WPP', 'PayPal Website Payments Pro (ej rekommenderad)');
  define('MODULE_PAYMENT_PAYPALDP_TEXT_ADMIN_TITLE_PRO20', 'PayPal Website Payments Pro Payflow Edition (UK) (ej rekommenderad)');

  if (IS_ADMIN_FLAG === true) {
    define('MODULE_PAYMENT_PAYPALDP_TEXT_ADMIN_DESCRIPTION', '<strong>PayPal Website Payments Pro</strong>%s<br />' . '<a href="http://www.zen-cart.com/partners/paypal-pro" target="_blank">Hantera ditt PayPal konto.</a>' . '<br /><br /><font color="green">Konfiguration Instruktioner:</font><br /><span class="alert">1. </span><a href="http://www.zen-cart.com/partners/paypal-pro" target="_blank">Registrera ett PayPal konto - klicka h&auml;r.</a><br />' .
...
'<font color="green"><hr /><strong>Requirements:</strong></font><br /><hr />*<strong>Express Checkout</strong> must be installed and activated in order to use Website Payments Pro, according to PayPal Terms of Service. <br /><hr />' );
  ...
  define ('MODULES_PAYMENT_PAYPALWPP_AGGREGATE_CART_CONTENTS', 'Alla objekt i din varukorg (se detaljer i butiken och p&aring; kvittot ).');
