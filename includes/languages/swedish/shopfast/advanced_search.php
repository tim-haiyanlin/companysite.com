 ...
 */
  ...
  define('NAVBAR_TITLE_2', 'S&ouml;k Resultat');

  define('HEADING_TITLE_1', 'Avancerad S&ouml;kning');
  define('HEADING_TITLE_2', 'Produkter som st&auml;mmer mot s&ouml;kningen');

  define('HEADING_SEARCH_CRITERIA', 'V&auml;lj din s&ouml;k term');

  define('TEXT_SEARCH_IN_DESCRIPTION', 'S&ouml;k i produkt beskrivningen');
  define('ENTRY_CATEGORIES', 'Begr&auml;nsa till kategori');
  define('ENTRY_INCLUDE_SUBCATEGORIES', 'Inkludera underkategorier');
  define('ENTRY_MANUFACTURERS', 'Begr&auml;nsa till tillverkare');
define('ENTRY_PRICE_RANGE', 'S&ouml;k efter prisniv&aring;');
  define('ENTRY_PRICE_FROM', 'Pris fr&aring;n:');
  define('ENTRY_PRICE_TO', 'Pris till:');
define('ENTRY_DATE_RANGE', 'S&ouml;k p&aring; datum inlagd');
  ...
  define('TEXT_NO_PRODUCTS', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Det finns inga produkter som passar p&aring; din s&ouml;kning.');
  define('KEYWORD_FORMAT_STRING', 'Sökord');
  define('ERROR_AT_LEAST_ONE_INPUT', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Minst ett av f&auml;lten m&aring;ste anv&auml;ndas f&ouml;r s&ouml;kning');
  ...
  define('ERROR_PRICE_TO_LESS_THAN_PRICE_FROM', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Pris till m&aring;ste vara h&ouml;gre &auml;n fris fr&aring;n.');
