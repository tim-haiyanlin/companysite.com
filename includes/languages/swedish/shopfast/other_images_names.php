...
define('OTHER_BOX_NOTIFY_REMOVE_ALT', 'Radera denna produkt notering.');
define('OTHER_BOX_NOTIFY_YES_ALT', 'Meddela mig om uppdateringar f&ouml;r denna produkt.');
define('OTHER_BOX_WRITE_REVIEW_ALT', 'Skriv en recension f&ouml;r denna produkt.');
define('OTHER_CALL_FOR_PRICE_ALT', 'V&Auml;nligen ring f&ouml;r aktuellt pris.');
define('OTHER_DOWN_FOR_MAINTENANCE_ALT', 'Sidan &auml;r nere f&ouml;r underh&aring;ll.');
define('OTHER_TRANPARENT_ALT', '');
define('OTHER_IMAGE_CUSTOMERS_AUTHORIZATION_ALT', 'KUNDGODK&Auml;NNANDE V&Auml;NTAR ...');
define('OTHER_REVIEWS_RATING_STARS_FIVE_ALT', 'Fem Stj&auml;rnor');
define('OTHER_REVIEWS_RATING_STARS_FOUR_ALT', 'Fyra Stj&auml;rnor');
define('OTHER_REVIEWS_RATING_STARS_THREE_ALT', 'Tre Stj&auml;rnor');
define('OTHER_REVIEWS_RATING_STARS_TWO_ALT', 'Tv&aring; Stj&auml;rnor');
define('OTHER_REVIEWS_RATING_STARS_ONE_ALT', 'en Stj&auml;rna');
