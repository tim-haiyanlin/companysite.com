...
define('BUTTON_CREATE_ACCOUNT_ALT', 'Registrera');
define('BUTTON_LOG_OFF_ALT', 'Logga ut');
define('BUTTON_ADD_TO_CART_ALT', 'L&auml;gg i kundkorg');
define('BUTTON_ADD_ADDRESS_ALT', 'L&auml;gg till adress');
define('BUTTON_ADD_PRODUCTS_TO_CART_ALT','L&auml;gg valda produkter i kundkorgen');
define('BUTTON_BACK_ALT', 'Tillbaka');
define('BUTTON_BUY_NOW_ALT', 'K&ouml;p Nu');
define('BUTTON_CANCEL_ALT', '&Aring;ngra');
define('BUTTON_CHANGE_ADDRESS_ALT', '&Auml;ndra adress');
define('BUTTON_CHECKOUT_ALT', 'Kassa');
define('BUTTON_CONFIRM_SEND_ALT', 'Skicka presentkort');
define('BUTTON_CONFIRM_ORDER_ALT', 'Bekr&auml;fta order');
define('BUTTON_CONTINUE_ALT', 'Forts&auml;tt');
define('BUTTON_CONTINUE_SHOPPING_ALT', 'Forts&auml;tt Handla');
define('BUTTON_DELETE_ALT', 'Radera');
define('BUTTON_DELETE_SMALL_ALT', 'Radera');
define('BUTTON_DOWNLOAD_ALT', 'Ladda ner nu');
define('BUTTON_EDIT_SMALL_ALT', '&Auml;ndra');
define('BUTTON_IN_CART_ALT', 'L&auml;gg i kundkorg');
define('BUTTON_LOGIN_ALT', 'Registrera');
define('BUTTON_PREVIOUS_ALT', '<i class="fa fa-angle-left" data-toggle="tooltip" data-original-title="Föregående artikel""></i>');
define('BUTTON_NEXT_ALT', '<i class="fa fa-angle-right" data-toggle="tooltip" data-original-title="Nästa artikel""></i>');
define('BUTTON_REDEEM_ALT', 'L&ouml;s ut');
define('BUTTON_RETURN_TO_PROD_LIST_ALT', 'Lista');
define('BUTTON_REVIEWS_ALT', 'G&aring; till recension sidan');
define('BUTTON_SEARCH_ALT', 'S&ouml;k');
define('BUTTON_SEND_ALT', 'Skicka nu');
define('BUTTON_SEND_ANOTHER_ALT', 'Skicka ett annat presentkort');
define('BUTTON_SEND_A_GIFT_CERT_ALT', 'Skicka ett presentkort');
define('BUTTON_SHIPPING_ESTIMATOR_ALT', 'Frakt ber&auml;kning');
define('BUTTON_SOLD_OUT_ALT', 'Sluts&aring;ld');
define('BUTTON_SOLD_OUT_SMALL_ALT', 'Sluts&aring;ld');
define('BUTTON_SUBMIT_ALT', 'Skicka informationen');
define('BUTTON_TELL_A_FRIEND_ALT', 'Ber&auml;tta f&ouml;r en v&auml;n');
define('BUTTON_TELLAFRIEND_ALT', 'Ber&auml;tta f&ouml;r en v&auml;n');
define('BUTTON_UNSUBSCRIBE', 'Avanm&auml;lan');
define('BUTTON_UPDATE_ALT', 'Uppdatera');
define('BUTTON_VIEW_SMALL_ALT', 'Visa');
define('BUTTON_WRITE_REVIEW_ALT', 'Skriv en recension');
define('BUTTON_READ_REVIEWS_ALT', 'L&auml;s recension');
define('BUTTON_GOTO_PROD_DETAILS_ALT', 'G&aring; till produktdetaljsidan');
define('BUTTON_MORE_REVIEWS_ALT', 'L&auml;s fler recensioner');
?>