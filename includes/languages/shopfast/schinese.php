...
// javascript messages
  define('JS_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>在处理您的表格过程中出错.\n\n请做以下修改:\n\n');

  define('JS_REVIEW_TEXT', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>* 请多写些内容。评论字数不能少于' . REVIEW_TEXT_MIN_LENGTH . '个字符。');
  define('JS_REVIEW_RATING', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>* 请对商品评级。');

  define('JS_ERROR_NO_PAYMENT_MODULE_SELECTED', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>* 请选择支付方式。');

  define('JS_ERROR_SUBMITTED', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>这个表格已经递交，请按确定并等待处理完成。');

  define('ERROR_NO_PAYMENT_MODULE_SELECTED', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>请选择支付方式。');
  define('ERROR_CONDITIONS_NOT_ACCEPTED', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>请点击以下方框以接受该订单的相应条款。');
  define('ERROR_PRIVACY_STATEMENT_NOT_ACCEPTED', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>请点击以下方框以接受隐私声明。');
  ...
  define('ENTRY_GENDER_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>请选择称呼。');
  define('ENTRY_GENDER_TEXT', '*');
  define('ENTRY_FIRST_NAME', '名字：');
  define('ENTRY_FIRST_NAME_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>名字输入正确吗？本系统要求名字不能少于' . ENTRY_FIRST_NAME_MIN_LENGTH . '个字符。');
  define('ENTRY_FIRST_NAME_TEXT', '*');
  define('ENTRY_LAST_NAME', '姓氏：');
  define('ENTRY_LAST_NAME_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>姓氏输入正确吗？本系统要求姓氏不能少于' . ENTRY_LAST_NAME_MIN_LENGTH . '个字符。');
  define('ENTRY_LAST_NAME_TEXT', '*');
  define('ENTRY_DATE_OF_BIRTH', '出生日期：');
  define('ENTRY_DATE_OF_BIRTH_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>出生日期输入正确吗？本系统要求出生日期的格式为:年/月/日 (例如 1970/05/21)');
  define('ENTRY_DATE_OF_BIRTH_TEXT', '* 例如 1970/05/21');
  define('ENTRY_EMAIL_ADDRESS', '电子邮件：');
  define('ENTRY_EMAIL_ADDRESS_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>电子邮件地址不能少于' . ENTRY_EMAIL_ADDRESS_MIN_LENGTH . '个字符。');
  define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>电子邮件地址不正确。 - 请做必要的修改。');
  define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>电子邮件地址已经在我们的数据库中。请用该电子邮件地址登录，然后可以在我的帐号中修改邮件地址。');
  define('ENTRY_EMAIL_ADDRESS_TEXT', '*');
  define('ENTRY_NICK', '论坛昵称：');
  define('ENTRY_NICK_TEXT', '*'); // note to display beside nickname input field
  define('ENTRY_NICK_DUPLICATE_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>该昵称已经存在。');
  define('ENTRY_NICK_LENGTH_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>昵称不能少于' . ENTRY_NICK_MIN_LENGTH . '个字符。');
  define('ENTRY_STREET_ADDRESS', '详细地址：');
  define('ENTRY_STREET_ADDRESS_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>详细地址不能少于' . ENTRY_STREET_ADDRESS_MIN_LENGTH . '个字符。');
  define('ENTRY_STREET_ADDRESS_TEXT', '*');
  define('ENTRY_SUBURB', '');
  define('ENTRY_SUBURB_ERROR', '');
  define('ENTRY_SUBURB_TEXT', '');
  define('ENTRY_POST_CODE', '邮编：');
  define('ENTRY_POST_CODE_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>邮编不能少于' . ENTRY_POSTCODE_MIN_LENGTH . '个字符。');
  define('ENTRY_POST_CODE_TEXT', '*');
  define('ENTRY_CITY', '城市：');
  define('ENTRY_CUSTOMERS_REFERRAL', '推荐人代码：');

  define('ENTRY_CITY_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>城市不能少于' . ENTRY_CITY_MIN_LENGTH . '个字符。');
  define('ENTRY_CITY_TEXT', '*');
  define('ENTRY_STATE', '省份：');
  define('ENTRY_STATE_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>省份不能少于' . ENTRY_STATE_MIN_LENGTH . '个字符。');
  define('ENTRY_STATE_ERROR_SELECT', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>请在下拉菜单中选择省份。');
  define('ENTRY_STATE_TEXT', '*');
  define('JS_STATE_SELECT', '-- 请选择 --');
  define('ENTRY_COUNTRY', '国家或地区：');
  define('ENTRY_COUNTRY_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>请在下拉菜单中选择国家或地区。');
  define('ENTRY_COUNTRY_TEXT', '*');
  define('ENTRY_TELEPHONE_NUMBER', '电话：');
  define('ENTRY_TELEPHONE_NUMBER_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>电话号码不能少于' . ENTRY_TELEPHONE_MIN_LENGTH . '个字符。');
  ...
  define('ENTRY_PASSWORD_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>密码不能少于' . ENTRY_PASSWORD_MIN_LENGTH . '个字符。');
  define('ENTRY_PASSWORD_ERROR_NOT_MATCHING', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>两次输入的密码必须一致。');
  define('ENTRY_PASSWORD_TEXT', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>* (至少' . ENTRY_PASSWORD_MIN_LENGTH . '个字符)');
  define('ENTRY_PASSWORD_CONFIRMATION', '确认密码：');
  define('ENTRY_PASSWORD_CONFIRMATION_TEXT', '*');
  define('ENTRY_PASSWORD_CURRENT', '当前密码：');
  define('ENTRY_PASSWORD_CURRENT_TEXT', '*');
  define('ENTRY_PASSWORD_CURRENT_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>密码不能少于' . ENTRY_PASSWORD_MIN_LENGTH . '个字符。');
  define('ENTRY_PASSWORD_NEW', '新密码：');
  define('ENTRY_PASSWORD_NEW_TEXT', '*');
  define('ENTRY_PASSWORD_NEW_ERROR', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>新密码不能少于' . ENTRY_PASSWORD_MIN_LENGTH . '个字符。');
  define('ENTRY_PASSWORD_NEW_ERROR_NOT_MATCHING', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>两次输入的密码必须一致。');
...
// constants for use in zen_prev_next_display function
  ...
  define('TEXT_CCVAL_ERROR_INVALID_DATE', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>输入的信用卡有效期不正确。请检查日期再试。');
  define('TEXT_CCVAL_ERROR_INVALID_NUMBER', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>输入的信用卡号不正确。请检查卡号再试。');
  define('TEXT_CCVAL_ERROR_UNKNOWN_CARD', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>输入的以%s开头的信用卡号码不正确，或者是我们无法接受此类信用卡。请再试一次或使用另外一个信用卡。');
...
// for all pages except where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCT', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>成功添加商品到购物车 ...');
// only for where multiple add to cart is used:
  define('SUCCESS_ADDED_TO_CART_PRODUCTS', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>成功添加选择的商品到购物车 ...');
...
// iii 031104 added:  File upload error strings
  define('ERROR_FILETYPE_NOT_ALLOWED', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>错误: 文件类型不允许。');
  define('WARNING_NO_FILE_UPLOADED', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>警告: 没有文件上传。');
  define('SUCCESS_FILE_SAVED_SUCCESSFULLY', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>成功: 文件存盘完成。');
  define('ERROR_FILE_NOT_SAVED', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>错误: 文件未存盘。');
  define('ERROR_DESTINATION_NOT_WRITEABLE', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>错误: 目标位置不可写入。');
  define('ERROR_DESTINATION_DOES_NOT_EXIST', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>错误: 目标位置不存在。');
  define('ERROR_FILE_TOO_BIG', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>警告: 文件太大，无法上传!<br />可以继续订单但请联系店主上传文件');
// End iii added
...
// product_listing
  ...
  define('ERROR_MAXIMUM_QTY','<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>添加到购物车的商品数量已调整，因为超过最多购买数量，见商品:<br /> ');
  define('ERROR_CORRECTIONS_HEADING','<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>请在下面修改: <br />');
  define('ERROR_QUANTITY_ADJUSTED', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>添加到购物车的商品数量已调整，您需要的商品不零卖，商品数量: <br />');
...
// shopping cart errors
  ...
  define('WARNING_SHOPPING_CART_COMBINED', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>提示: 为了方便购物，您当前购物车中的商品与您以前购物车中的商品合并了，结帐前请查看您的购物车。');
  define('WARNING_PRODUCT_QUANTITY_ADJUSTED', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>数量已根据库存调整。');

// error on checkout when $_SESSION['customers_id' does not exist in customers table
  define('ERROR_CUSTOMERS_ID_INVALID', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>无法核对客户信息!<br />请登录或重新注册 ...');
