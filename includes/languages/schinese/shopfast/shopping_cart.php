...
define('TABLE_HEADING_UPDATE', '更新');
define('TABLE_HEADING_DELETE', '删除');

define('OUT_OF_STOCK_CANT_CHECKOUT', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>标记为' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . '的商品缺货或库存不足。<br />请修改标记为(' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . ')的商品数量。谢谢！');
define('OUT_OF_STOCK_CAN_CHECKOUT', '<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>标记为' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . '的商品缺货。<br />缺货的商品将稍后发货。');
