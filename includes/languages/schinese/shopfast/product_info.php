...
define('TEXT_ALSO_PURCHASED_PRODUCTS', '还购买了');
...
define('TEXT_PRODUCT_QUICK_OVERVIEW', '快速查看');
define('TEXT_PRODUCT_QUICK_DESCRIPTION', '描述');
define('TEXT_PRODUCT_QUICK_REVIEWS', '点评');
define('TEXT_PRODUCT_NO_REVIEWS', '没有评论此产品.');
