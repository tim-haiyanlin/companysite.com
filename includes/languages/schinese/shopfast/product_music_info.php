...
define('TEXT_PRODUCT_NOT_FOUND', '对不起，没找到该商品。');
define('TEXT_CURRENT_REVIEWS', '当前评论:');
define('TEXT_RECORD_COMPANY_URL', '详情请访问该唱片公司的<a href="%s" target="_blank">网站</a>。');
define('TEXT_ARTIST_URL', '详情请访问该歌手<a href="%s" target="_blank">网页</a>。');
...
define('TEXT_PRODUCT_RECORD_COMPANY', '唱片公司: ');
define('TEXT_PRODUCT_ARTIST', '歌手名字: ');
define('TEXT_PRODUCT_MUSIC_GENRE', '音乐类型: ');
define('TEXT_PRODUCT_WEIGHT', '重量: ');
define('TEXT_PRODUCT_QUANTITY', ' 库存');
define('TEXT_PRODUCT_MODEL', '型号: ');
define('TEXT_PRODUCT_COLLECTIONS', '媒体收集: ');
