...
define('TEXT_RSS_CATEGORIES', 'RSS Kategorie Feed');
define('TEXT_RSS_SPECIALS', 'RSS Sonderangebote Feed');
define('TEXT_RSS_FEATURED_PRODUCTS', 'RSS Wir empfehlen Feed');
define('TEXT_RSS_UPCOMING_PRODUCTS', 'RSS Kommende Artikel Feed');
define('TEXT_RSS_PRODUCTS_NEW', 'RSS Neue Produkte Feed');
define('TEXT_RSS_BEST_SELLERS', 'RSS Bestseller Feed');