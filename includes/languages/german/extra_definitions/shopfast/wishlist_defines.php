...
define('SUCCESS_ADDED_TO_WISHLIST_PRODUCT', '<button class="close" aria-hidden="true" data-dismiss="alert" type="button">×</button>Erfolgreich hinzugefügt Produkt auf den Merkzettel');
