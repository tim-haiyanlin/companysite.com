...
define('TEXT_ALSO_PURCHASED_PRODUCTS','ebenfalls gekauft');
...
define('TEXT_PRODUCT_QUICK_OVERVIEW', 'Kurzübersicht');
define('TEXT_PRODUCT_QUICK_DESCRIPTION', 'Beschreibung');
define('TEXT_PRODUCT_QUICK_REVIEWS', 'Bewertungen');
define('TEXT_PRODUCT_NO_REVIEWS', 'Es gibt keine Bewertungen für dieses Produkt.');
