...
define('TABLE_HEADING_UPDATE', 'Aktualisierung');
define('TABLE_HEADING_DELETE', 'Löschen');
define('TABLE_HEADING_PRICE','Einheit');
define('TEXT_CART_EMPTY','Ihr Warenkorb ist leer.');
define('SUB_TITLE_SUB_TOTAL','Zwischensumme:');
define('SUB_TITLE_TOTAL','Gesamt:');

define('OUT_OF_STOCK_CANT_CHECKOUT','<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Artikel, die markiert sind, ' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . ' sind zurzeit leider nicht in ausreichender Menge auf Lager.<br />Bitte ändern Sie die Menge bei den Artikeln, die mit (' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . ') gekennzeichnet sind. Vielen Dank!');
define('OUT_OF_STOCK_CAN_CHECKOUT','<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Artikel, die markiert sind, ' . STOCK_MARK_PRODUCT_OUT_OF_STOCK . ' sind zurzeit leider nicht auf Lager.<br/>Diese Artikel werden nachgeliefert.');
