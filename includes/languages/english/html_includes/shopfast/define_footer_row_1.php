...
<!-- Footer Row 1 Column 3  Hidden twitter function-->
<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">


<?php 
 $testimonials_manager='testimonials_manager.php';
 require(DIR_WS_MODULES . 'sideboxes/' . $template_dir . '/' .  $testimonials_manager);
?>
