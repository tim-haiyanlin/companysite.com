...
define('BUTTON_IMAGE_BUY_NOW', '<i class="fa fa-shopping-cart fa-lg"></i>');
...
define('BUTTON_AJAX_BUY_NOW_ALT', '<i class="fa fa-shopping-cart fa-lg"></i>');
...
define('BUTTON_NEXT_ALT', '<i class="fa fa-angle-right" data-toggle="tooltip" data-original-title="Next Product""></i>');
define('BUTTON_PREVIOUS_ALT', '<i class="fa fa-angle-left" data-toggle="tooltip" data-original-title="Previous Product""></i>');
