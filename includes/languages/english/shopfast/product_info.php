...
define('TEXT_ALSO_PURCHASED_PRODUCTS', 'Also purchased');
...
define('TEXT_PRODUCT_QUICK_OVERVIEW', 'Quick Overview');
define('TEXT_PRODUCT_QUICK_DESCRIPTION', 'Description');
define('TEXT_PRODUCT_QUICK_REVIEWS', 'Reviews');
define('TEXT_PRODUCT_NO_REVIEWS', 'There are no reviews for this product.');
