...
// test if box should display
  ...
  if (SHOW_BANNERS_GROUP_SET11 == '') {
    $show_banner_box6 = false;
  }

  if ($show_banner_box6 == true) {
    $banner_box[] = TEXT_BANNER_BOX1;
    $banner_box_group= SHOW_BANNERS_GROUP_SET11;

    require($template->get_template_dir('tpl_banner_box1.php',DIR_WS_TEMPLATE, $current_page_base,'sideboxes'). '/tpl_banner_box1.php');
