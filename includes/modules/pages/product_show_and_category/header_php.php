<?php
 define('NAVBAR_TITLE', 'Categories and Featured Products');
$breadcrumb->add(NAVBAR_TITLE);

$sql="SELECT * FROM ".TABLE_CATEGORIES." c, ".TABLE_CATEGORIES_DESCRIPTION." cd WHERE c.parent_id =0
...
include(DIR_WS_MODULES . zen_get_module_directory(FILENAME_DYNAMIC_FILTER));
   ...
   // show productss model  p.products_model    web index.php?main_page=index&pg=store&cPath=21 2015 07 20 tim

$listing_sql = "SELECT p.products_id, p.products_model, p.products_type, pd.products_name, p.products_image, p.products_price, p.products_tax_class_id, p.products_date_added, m.manufacturers_name, 
