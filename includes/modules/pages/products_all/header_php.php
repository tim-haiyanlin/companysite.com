...
// bof dynamic filter 1 of 1
 ...
 // show productss model  p.products_model 
  $listing_sql = "SELECT DISTINCT p.products_type, p.products_id, p.products_model, pd.products_name, p.products_image, p.products_price,
