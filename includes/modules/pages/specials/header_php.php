...
if (MAX_DISPLAY_SPECIAL_PRODUCTS > 0 ) {
  ...
  // show productss model  p.products_model 2015 07 23 tim
  $listing_sql = "SELECT DISTINCT p.products_id, p.products_model, p.products_image, pd.products_name, p.master_categories_id, p.manufacturers_id";
